...
namespace {
struct qt_meta_tag_ZN10SortDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10SortDialogE = QtMocHelpers::stringData(
    "SortDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10SortDialogE[] = {
...
Q_CONSTINIT const QMetaObject SortDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10SortDialogE.offsetsAndSizes,
    qt_meta_data_ZN10SortDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10SortDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *SortDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10SortDialogE.stringdata0))
